...
describe.only('loadFromConfig', () => {
  ...
  describe('loadFromConfig', () => {
    it('should pull out specs and suites', () => {
      ...
      expect(suites.someSuite).toEqual(
        expect.arrayContaining(['./replay-12314/test1.js'])
      )
    })
    ...
    it('should throw error if invalid JSON in file', () => {
      ...
      expect(loadFromConfig.bind(null)).toThrow(
        'replay.config.json did not have valid JSON'
      )
    })
    ...
    it('should throw error if config not found', () => {
      ...
      expect(loadFromConfig.bind(null)).toThrow(
        'No replay.config.json found in the current directory'
      )
    })
