...
class CommandOptions extends React.Component {
  ...
  switchToBlockByName = (name) => {
    return new Promise((resolve, reject) => {
      ...
      if (targetBlock) {
        ...
        return Promise.reject('ERROR: CommandOption: Unable to find ID for block name: ' + name)
      }
    })
  }
  ...
  render () {
    ...
    const dataSource = filterCommands && filterCommands.length ? filterCommands : defaultDataSource
