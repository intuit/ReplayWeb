...
export class Player {
  ...
  play(config) {
    ...
    const basicState = {
      ...
      title,
      extra,
      startUrl: Ext.extension.getURL('start.html'),
      startIndex,
      endIndex,
      resources,
      // other stuff
...
// factory function to return a player singleton, if passed in with opt, it will construct a new player, otherwise,
